                ...
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href={{env('FRONTEND_URL')}} title="logo" target="_blank">
                            <img width="60" src="https://e7.pngegg.com/pngimages/195/1015/png-clipart-logo-thunder-lightning-brand-product-logo-oklahoma-city-thunder-blue-text.png" title="logo" alt="logo">
                          </a>
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                            Your account has been created on the {{ env('APP_NAME') }}. Below are your system generated credentials, <br><strong>Please change
                                                the {{$credential_type}} immediately after login</strong>.</p>
                                        <span
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>{{env('FRONTEND_URL')}}</strong> </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
